...
class SecondGUI(tk.Tk):
    def __init__(self):
        super().__init__()
        self.state = False
        self.toggle_fullscreen()  # Initialize with fullscreen mode
        self.config(bg="#e4f1fe")  # Set light background color for a soft and professional look

        # Set window icon, update the path accordingly
        self.iconbitmap(r"C:\Users\HP\Downloads\4288596analyticschartgrowthincreasingstocks-115760_115753.ico")

        self.make_title()  # Create title section
    ...
    def update_layout(self):
        # Update layout and resize images when window dimensions change
        width = self.winfo_width()
        height = self.winfo_height()

        if width > 0 and height > 0:
            # Adjust background images to fit fullscreen
            ...
            # Re-create buttons after layout update
            self.create_buttons()

    def make_title(self):
        # Create title section with professional look
        title_frame = tk.Frame(self, bg="#2980b9", height=100)  # Set color for title
        ...
        self.create_frames()  # Create left and right frames

    def create_frames(self):
        # Create left and right frames with aesthetic background colors
    ...
    def create_buttons(self):
        # Left Button: Stock recommendation functionality
        ...
        # Left side button for stock recommendation
        ...
        # Right Button: Stock analysis functionality
        ...
        # Right side button for stock analysis
